#!/usr/bin/env python3
"""
🎵 Test Directo de Suno - Verificar integración real
"""
...
from suno_real_integration import suno_integration, setup_suno_credentials

async def test_suno_direct():
    """Test directo de la integración con Suno"""
    
    print("🎵 TEST DIRECTO DE SUNO")
    print("=" * 50)
    ...
    # Verificar estado
    print("\n🔍 Verificando estado de Suno...")
    status = await suno_integration.check_suno_connection()
    print(f"Estado: {status}")
    
    # Probar generación
    print("\n🎵 Probando generación real...")
    result = await suno_integration.generate_music_real(
        prompt="test song",
